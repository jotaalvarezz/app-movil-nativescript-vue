<template>
    <page>
        ...
        <ScrollView height="100%" backgroundColor="#cceeff">
            <card-view class="position" ripple="true" elevation="20" margin="4" radius=20 backgroundColor="#3c495e" height="auto" width="95%">
                <FlexboxLayout flexDirection="column" paddingBottom="20" height="50%">
                    ...
                    <GridLayout columns="auto, *" rows="auto,auto,auto" height="auto" marginTop="7">
                        <Label style="font-weight: bold;" class="info_title" text="Title:" marginLeft="20" row="0" col="0"></Label>
                        <Label :text="info.title" textWrap="true" class="info_title" marginLeft="5" marginRight="20" row="0" col="1"></Label>
                        <Label style="font-weight: bold;" class="info_title" :text="sinopsis" marginLeft="20" row="1" col="0"></Label>
                        <Label :text="info.synopsis" class="info_title" textWrap="true" marginLeft="5" marginRight="20" row="1"
                            col="1"></Label>
                        <Label style="font-weight: bold;" class="info_title" text="type:" marginLeft="20" row="2" col="0"></Label>
